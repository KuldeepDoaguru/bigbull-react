  ...
  return (
    <div className="footer-outer">
      ...
      >
        ...
        <div className="myfooter">
          ...
          <div className="sub-section">
            ...
            <div className="section-3">
              <h1>Contact</h1>
              <p>
                <i className="fas fa-home me-3"></i>Jabalpur(482002), Madhya
                Pradesh, India
              </p>
              <p>
              ...
              <p>
                <i className="fas fa-phone me-3"></i>+91 8602161019
              </p>
              {/* <p>
        ...
        >
          © 2022 Copyright:&nbsp;
          <a className="text-reset fw-bold" href="https://bigbulltrading.com/">
            bigbulltrading.com
          </a>
        </div>
      </MDBFooter>
