        ...
        <div className="container-fluid bgColor">
          <div className="row my-5 ms-5 me-5">
            ...
            <div className="col-sm-6 my-5 ">
              <img
                className="img-fluid"
                src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1696089725/preview_1_fj7ejw.jpg"
              />
            </div>
          </div>
          {/* editing  */}
                ...
                <div className="carousel-item active">
                  <div className="card-group">
                    <div className="card d-flex mr-3  h-100">
                      <img
                        src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1696238330/testomonail_image_oix0yn.png"
              ...
              <div className="row ms-5 me-5 ">
                <div className="col-sm-6">
                  <img
                    ...
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1696089460/preview2_utufgw.jpg"
                  />
                </div>
                <div className="col-sm-6 my-5">
