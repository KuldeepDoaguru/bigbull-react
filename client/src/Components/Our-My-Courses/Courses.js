            ...
            <div className="container mb-5">
              <div className="card-group">
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5 ">
                  <img
                    className="card-img-top fluid rounded-5 card-image"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997655/people-education-and-learning-concept-woman-or-student-girl-with-laptop-computer-writing-to-notebook-at-home-at-night_rjm6h3dul_thumbnail-1080_01_h6rafo.png"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between">
                      <span>
                        <img
                          className="start flex-start"
                          src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695995682/5s_carbct.jpg"
                        />
                      </span>
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5 ">
                  <img
                    className="card-img-top fluid rounded-5 card-image"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997653/OIP_8_v60bnr.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p>my third video</p>
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className="card-img-top fluid rounded-5 card-image "
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997655/writing-735x400_eae1ot.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className="card-img-top fluid rounded-5 card-image "
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997652/OIP_7_yldqfc.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p className="">my fourth video</p>
            ...
            <div className="container mb-5">
              <div className="card-group">
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5 ">
                  <img
                    className="card-img-top fluid rounded-5 card-image"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695998252/OIP_11_ncdytq.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p>my third video</p>
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className="card-img-top fluid rounded-5 card-image "
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695998252/OIP_10_uobyqx.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p className="">my fourth video</p>
              ...
              <div className="card-group">
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5 ">
                  <img
                    className="card-img-top fluid rounded-5 card-image"
                    id="cbimg"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997651/fotolia_19774255_l_5_gq3nza.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p>my first video </p>
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className="card-img-top fluid rounded-5 card-image"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997650/invest-in-mutual-funds-770x462_d5duld.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p className="">my fourth video</p>
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className=" card-img-top fluid rounded-5 card-image"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997651/OIP_4_fqyavl.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p>my second video</p>
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className="card-img-top fluid rounded-5 card-image "
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695997651/OIP_5_ualdd1.jpg"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p className="">my fourth video</p>
            ...
            <div className="container   mb-5">
              <div className="card-group">
                ...
                <div className="card d-flex mr-3 shadow-0 h-100 border rounded-5">
                  <img
                    className="card-img-top fluid rounded-5  card-image"
                    src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695988708/b2_z5n3y5.webp"
                    alt="Video Thumbnail"
                  />
                  <div className="card-body">
                    <p className="">my fourth video</p>
