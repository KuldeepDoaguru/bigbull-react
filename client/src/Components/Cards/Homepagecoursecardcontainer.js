        ...
        <>
            <div className='home-all-card-container-outer'>
                ...
                <div className="container">
                    <h2 className="text-center mb-5" id="spo">Specail Offers</h2>
                </div>
                            ...
                            <div className="carousel-item active">
                                <div className="card-group">
                                    <div className="card d-flex mr-3 border">
                                        <img src="https://res.cloudinary.com/dwivqhrnx/image/upload/v1695824574/headerimage-98_uscnih.jpg" class="card-img-top" alt="Video Thumbnail" />
